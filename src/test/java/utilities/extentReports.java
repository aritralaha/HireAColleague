...
public class extentReports implements ITestListener {
    ...
    public void onStart(ITestContext context) {
        ...
        sparkReporter.config().setDocumentTitle("Hiring a colleague Automation report"); //title of the report
        sparkReporter.config().setReportName("Integration testing"); //name of the report
        sparkReporter.config().setTheme(Theme.DARK);

        extent =new com.aventstack.extentreports.ExtentReports();
        extent.attachReporter(sparkReporter);
        extent.setSystemInfo("Application", "ResourceLink");
        extent.setSystemInfo("Module", "JML");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try{
            String imgPath = new baseClass().captureScreenForFailure(result.getName());
